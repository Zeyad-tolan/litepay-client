  ...
  return (
    <tr className="border-t">
      ...
      <td className={`font-normal py-1 text-center`}>
        <span
          className={`flex justify-center mx-auto items-center gap-1 ${data.status === "pending"
      ...
      <td className={`font-normal py-1 text-center`}>
        ...
        <PopUpImage src={data.attachments ? data.attachments[0] : `${srcImage}`} setShow={setShowImage} show={showImage}/>
      </td>
    </tr>
  );
}
