...
export default function PopEditBalance({ setShow, show }: IProp) {
    ...
    <PopUpLayout setShow={setShow} show={show} styleChildren="dark:bg-primaryDark">
      <form onSubmit={handSubmit} className="flex flex-col gap-2">
        <div className="">
          ...
          <input type="text" id="Card Balance" required name="cardBalance" placeholder="Card Balance" className="w-full outline-none border border-solid border-gray-300 rounded-full px-3 py-2 inputNum dark:bg-secondaryDark dark:text-black" />
        </div>
