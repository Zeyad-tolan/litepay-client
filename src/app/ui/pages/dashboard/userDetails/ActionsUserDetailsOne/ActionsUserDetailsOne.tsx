...
import { IconAddBalance, IconAddCard, IconChangeRate, IconRefund } from "@/src/app/icons/icons";
...
export default function ActionsUserDetailsOne({cards}:{cards:[]| cards[]}) {
  ...
  return (
    <>
      <div className={`flex flex-col gap-4 ${lang === "en" ? "pr-16 border-r border-r-gray-500" : "pl-16 border-l border-l-gray-500"} `}>
        ...
        <div onClick={() => setShowAddCard(true)} className={`flex flex-col gap-5 w-fit cursor-pointer`}>
          <div className="flex items-center text-lg font-medium px-4 w-fit border border-[#165E3D] rounded-full bg-[#EDFFEA] text-[#165E3D] gap-2">
        ...
        <div onClick={() => setShowChangeRate(true)} className={`flex flex-col gap-5 w-fit cursor-pointer`}>
          <div className="flex items-center text-lg font-medium px-4 w-fit border border-[#165E3D] rounded-full bg-[#EDFFEA] text-[#165E3D] gap-2">
            <IconChangeRate /> {t("change-rate")}
          </div>
        </div>
      </div>
      <PopUpAddBalance cards={cards} setShow={setShowAddBalance} show={showAddBalance} />
