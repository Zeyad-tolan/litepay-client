...
export const handelSubmitAddBalance = (e: FormEvent<HTMLFormElement>, rate: number, promo: string, type: string, lang: string, router: AppRouterInstance) => {
    e.preventDefault()
    ...
    if(allData.method === "instapay"){
        ...
        sendRequest(raw,"add-balance-wait","card-dashboard",router,lang,"add-balance")
    }
