...
export const getAllRating = async (
  setInsta: Dispatch<SetStateAction<number>>,
  setVodafoneCash: Dispatch<SetStateAction<number>>,
  setNormalUser: Dispatch<SetStateAction<number>>,
  setVipUser: Dispatch<SetStateAction<number>>
) => {
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}ratings?&sortKey=createdAt&sortValue=DESC`,
      {
        method: "GET",
        headers: myHeaders,
        redirect: "follow",
